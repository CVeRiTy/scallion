...
Binary Download
---------------
Just want a binary version? Grab it [here](https://github.com/lachesis/scallion/blob/binaries/scallion-v1.0.zip?raw=true).
...
Contact me at ```scallion@aftbit.com``` if you're interested in having me generate a key for you using this feature.
